  ...
  return (
    <>
      ...
      <main className="bg-white text-black">
        ...
        {/* Types of Projects We Take Section */}
        <section className="w-full px-6 py-24 sm:py-32 bg-white/30">
          <div className="w-full max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
              {/* Good Fit */}
              <div className="rounded-2xl border border-black/20 bg-white/60 backdrop-blur-sm p-8 lg:p-10 shadow-lg">
                ...
                <ul className="space-y-4 font-sans text-black/85 text-[15px] sm:text-base leading-relaxed">
                  {goodFitProjects.map((item) => (
                    <li key={item} className="flex gap-3">
                      <span className="text-black shrink-0 mt-0.5" aria-hidden>•</span>
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
              ...
              {/* Not a Fit */}
              <div className="rounded-2xl border border-black/15 bg-white/40 backdrop-blur-sm p-8 lg:p-10 shadow-md">
                <h3 className="font-display font-semibold text-black/80 text-xl sm:text-2xl tracking-tight mb-6">
                  Not a Fit
                </h3>
                <ul className="space-y-4 font-sans text-black/70 text-[15px] sm:text-base leading-relaxed">
        ...
        {/* What Clients Need to Provide Section */}
        <section className="w-full px-6 py-24 sm:py-32 bg-white/30">
          <div className="w-full max-w-6xl mx-auto">
            <h2 className="font-display font-bold text-black text-3xl sm:text-4xl md:text-[2.5rem] leading-tight tracking-tight text-center max-w-3xl mx-auto mb-6">
        ...
        <section className="w-full px-6 py-20 sm:py-28 bg-white/30">
          <div className="w-full max-w-4xl mx-auto text-center">
            ...
            <p className="mt-6 font-sans text-base sm:text-lg text-black/75 leading-relaxed max-w-2xl mx-auto">
              This page explains how we work. If you're looking for a development partner who values clarity, quality, and collaboration, let's start a conversation.
            </p>
            <div className="mt-10">
              <Link
                href="/contact"
