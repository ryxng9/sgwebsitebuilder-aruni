...
export default function HeroWaveWork() {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 w-full overflow-hidden pointer-events-none" style={{ height: "200px" }}>
      ...
      >
        <defs>
          {/* Gradient for the glow effect - yellow */}
        ...
        {/* Static wave path (drawn line) - white */}
        <path
          ref={pathRef}
        ...
        {/* Animated gradient glow following the wave - yellow */}
        <path
          d="M0,100 Q150,80 300,100 T600,100 T900,100 T1200,100"
          fill="none"
          stroke="url(#waveGradientYellow)"
          strokeWidth="6"
          strokeLinecap="round"
