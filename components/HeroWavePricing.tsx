...
export default function HeroWavePricing() {
    ...
    <div className="absolute bottom-0 left-0 right-0 w-full overflow-hidden pointer-events-none" style={{ height: "200px" }}>
      ...
      >
        <defs>
          ...
          <linearGradient id="waveGradientPricing" x1="0%" y1="0%" x2="100%" y2="0%">
        ...
        <path
          d="M0,100 Q150,80 300,100 T600,100 T900,100 T1200,100"
          fill="none"
          stroke="url(#waveGradientPricing)"
          strokeWidth="6"
          strokeLinecap="round"
          filter="url(#glowPricing)"
          className="wave-glow"
        />
      </svg>
